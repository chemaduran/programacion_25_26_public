...
public class clases_wrapper_integer {
  public static void main(String[] args) {
    ...
    Integer n1 = 20;
    Integer n2 = 20; // En versiones nuevas está deprecado (obsoleto).
    // IntelliJ lo tacha por innecesario.

    // Devuelve el valor equivalente
    int x = n2.intValue(); // lo que hace es devolver el int interno
    // que alberga este Integer
    double y = n1.doubleValue(); // lo mismo, pero además convirtiéndolo
    // a double
    ...
    // Métodos estáticos que devuelven un String con la representación
    // binaria, octal o hexadecimal del número.
    int numero = 12;

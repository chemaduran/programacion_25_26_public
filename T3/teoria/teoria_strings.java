...
public class teoria_strings {
  public static void main(String[] args) {
    ...
    // aparición de carácter dentro del String. Devuelve -1 si no lo
    // encuentra.
    System.out.println("La posición del caracter c es: " + s1.lastIndexOf("c"));
    ...
    String cadena1 = "AA";
    String cadena2 = "A";
	  System.out.println("¿Es el valor de comparación negativo o positivo?");
    System.out.println(cadena1.compareTo(cadena2));  // mayor que cero o menor que cero?

    System.out.println();

		// Cuidado que esto explota, porque se sale de rango en cadena2
